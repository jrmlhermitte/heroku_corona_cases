...
def get_canada_data_by_province(province: str):
    ...
    df_by_province.loc[:, "totalIncrease"] = (
        df_by_province["numtested"].diff() / time_intervals_days
    )
    df_by_province.loc[:, "positiveIncrease"] = (
        df_by_province["numconf"].diff() / time_intervals_days
    )
    df_by_province.loc[:, "negativeIncrease"] = (
        df_by_province["totalIncrease"] - df_by_province["positiveIncrease"]
    )
